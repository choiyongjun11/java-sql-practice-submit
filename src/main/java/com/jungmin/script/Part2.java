...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO users (username, email, password) VALUES ('CHOI','CHOI@gmail.com,', '1234');";
  ...
  */
  public static final String PART2_8 = "SELECT P.title, U.username from Posts P inner join Users U on U.user_id = P.user_id ";
  ...
  */
  public static final String PART2_10 = "INSERT INTO Posts (user_id, title, content) "
          + "VALUES (1, 'This title', 'This content');";
  ...
  */
  ...
  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-13. users 테이블의 user_id가 1인 유저가 작성한
       post의 board name을 찾기위한 SQL을 작성해주세요.
  */
  ...
  */
  public static final String PART2_15 = "SELECT COUNT(C.comment_id) AS CommentCount " +
